...
SECRET_KEY = 'django-insecure-@xlvb&btsq7(4g_ferwzat^7up$syguw*)y0^0iq0mib=0k5#l'
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'FamilyApp.utils.custom_exception_handler',
...
AUTH_USER_MODEL = 'FamilyApp.FamilyMember'
